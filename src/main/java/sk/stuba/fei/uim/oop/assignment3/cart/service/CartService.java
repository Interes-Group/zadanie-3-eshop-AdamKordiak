...
public class CartService implements ICartService {
    ...
    @Override
    public Cart addProductById(Long id, ProductListRequest productRequest) throws BadRequestException {
        ...
        for( ProductList productListIterator : cart.getShoppinglist()){
            if(productListIterator.getProductId().equals(productRequest.getProductId())){
                productListIterator.setAmount(productListIterator.getAmount()+productRequest.getAmount());
